...
84Key is an open, welcoming project. We want participation in our community to
be a harassment-free experience for everyone, regardless of age, body size,
...
and may take appropriate corrective action — including warnings, temporary bans,
or permanent removal from the project — in response to behavior they deem
inappropriate, threatening, or harmful.

## Attribution

This Code of Conduct is adapted from, and inspired by, the
[Contributor Covenant, version 2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct/).
Please refer to that document for a more comprehensive standard.
